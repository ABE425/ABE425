...
[Figure4][https://github.com/ABE425/ABE425/blob/master/data/hw/HW_TheveninEquivalents/HW_Thevenin3_VoltageSource.PNG] shows the circuit where the current source is replaced by its internal resistance, which is infinite, therefore the whole source simply disappears.
...
[Figure5][https://github.com/ABE425/ABE425/blob/master/data/hw/HW_TheveninEquivalents/HW_Thevenin3_CurrentSource.PNG] shows the circuit where the voltage source is replaced by its internal resistance, which is zero, therefore the source is replaced by a wire.
